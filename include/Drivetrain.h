...
#define TURN_MODE 1
#define SIMPLE_ARC_MODE 2
#define RADIAL_ARC_MODE 3
...
public:
    ...
    void driveArcSimple(float target_distance, Angle end_angle, ArcSettings arc_settings, float linear_max_speed, float angular_max_speed, PID linear_pid, PID angular_pid, IErrorProvider& linear_error_provider, IErrorProvider& angular_error_provider);
    void driveArcSimple(float target_distance, Angle end_angle, ArcSettings arc_settings, float linear_max_speed, float angular_max_speed, PID linear_pid, PID angular_pid);
    void driveArcSimple(float target_distance, Angle end_angle, float linear_max_speed, float angular_max_speed, PID linear_pid, PID angular_pid);
    void driveArcSimple(float target_distance, Angle end_angle, PID linear_pid, PID angular_pid);
    void driveArcRadial(float radius_inches, Angle end_angle, float linear_max_speed, float angular_max_speed, PID linear_pid, PID angular_pid, IErrorProvider& linear_error_provider, IErrorProvider& angular_error_provider);
