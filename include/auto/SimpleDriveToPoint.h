#ifndef SIMPLE_DRIVE_TO_POINT_SPEED_CONTROLLER_H
#define SIMPLE_DRIVE_TO_POINT_SPEED_CONTROLLER_H
...
class SimpleDriveToPoint: public BlackMagic::ISpeedController {
public:
    enum Phase {
        FACE_POINT,
        DRIVE_TO_POINT,
...
private:
    ...
    BlackMagic::Angle face_target_heading;
    ...
    bool hasPhaseSettled(const BlackMagic::DrivetrainState& drive_state);
};
